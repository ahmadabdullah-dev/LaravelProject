    ...
    <div class="container my-5">
        ...
        <div class="hero-section text-center">
            ...
            <div class="d-flex justify-content-center gap-3">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-light btn-lg px-4 text-primary fw-semibold shadow-sm">Go to Dashboard</a>
                    <?php if(Auth::user()->role === 'admin'): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-warning btn-lg px-4 fw-semibold shadow-sm">Admin Panel</a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-outline-light btn-lg px-4 shadow-sm">Manage Profile</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-light btn-lg px-4 text-primary fw-semibold shadow-sm">Get Started</a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light btn-lg px-4 shadow-sm">Create Account</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        </div>
...
<?php /**PATH C:\Users\Ahmed\Desktop\LaravelEcommerce\resources\views/welcome.blade.php ENDPATH**/ ?>